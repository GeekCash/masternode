...
# Allow outgoing GeekCash Masternode requests.
$IPTABLES -A OUTPUT -m state --state NEW -p tcp --dport 6889 -j ACCEPT
...
# Allow incomming GeekCash Masternode requests.
$IPTABLES -A INPUT -m state --state NEW -p tcp --dport 6889 -j ACCEPT
